"""Tests for RuleGuidance value object — frozen dataclass behavior."""
...
class TestRuleGuidanceFrozen:
    ...
    def test_frozen(self) -> None:
        """RuleGuidance should be a frozen dataclass."""
        g = _make_guidance()
        assert g.__dataclass_params__.frozen is True

    def test_cannot_modify_field(self) -> None:
        """Assigning to a field should raise FrozenInstanceError."""
        g = _make_guidance()
