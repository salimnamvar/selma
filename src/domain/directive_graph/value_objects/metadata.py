...
_PROHIBITED_KEY_PATTERN: re.Pattern[str] = re.compile(
    r"^(x-exec|x-eval|x-hint|evaluator_|evaluator\.)"
)
...
class DirectiveMetadata(BaseModel):
    ...
    Attributes:
        ...
        extensions (dict[str, Any]): Arbitrary extension fields (contamination-guarded).
    """
