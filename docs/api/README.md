...
**Structural SSoT:** [`../c4-model/`](../c4-model/README.md) (docs/standards/VERSION)  
...
| Certification AA-01…AA-09 | Offline/CI `certification_tool`; results as artifacts `kind=certification` |
