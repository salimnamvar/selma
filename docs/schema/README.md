...
> **Authority:** This directory is the **design-time SSoT** for executable rule and policy doctrine shapes. Design freeze: [`docs/standards/VERSION`](../standards/VERSION).  
