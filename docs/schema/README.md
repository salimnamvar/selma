...
> **Authority:** This directory is the **design-time SSoT** for executable rule and policy doctrine shapes under `design_contract_version` `1.1.0` (stamp of [`../standards/VERSION`](../standards/VERSION)).  
